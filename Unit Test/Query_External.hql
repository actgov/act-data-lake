...
LOAD DATA LOCAL INPATH './Busdata_CBR.txt' INTO TABLE ${hiveconf:TABLE_NAME} PARTITION(suburb='CBR');
LOAD DATA LOCAL INPATH './Busdata_BEL.txt' INTO TABLE ${hiveconf:TABLE_NAME} PARTITION(suburb='BEL');
LOAD DATA LOCAL INPATH './Busdata_WDN.txt' INTO TABLE ${hiveconf:TABLE_NAME} PARTITION(suburb='WDN');
