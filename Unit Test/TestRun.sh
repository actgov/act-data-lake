...
hive -hiveconf DB_NAME=$dbname -hiveconf TABLE_NAME=$tablename -f ./Query.hql
...
hive -hiveconf DB_NAME=$dbname -hiveconf TABLE_NAME=$tablename -f ./QueryPurge.hql
...
hive -hiveconf DB_NAME=$extdbname -hiveconf TABLE_NAME=$exttablename -f ./Query_External.hql
#clear
...
hive -hiveconf DB_NAME=$extdbname -hiveconf TABLE_NAME=$exttablename -f ./QueryExtPurge.hql
